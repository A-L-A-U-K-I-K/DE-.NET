<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="donate.aspx.cs" Inherits="FoodSavor.donate" %>
			...
			<div class="col-sm-6">
				...
				<div class="row">
					...
					<div class="col-sm-5">
						...
						<asp:Label ID="donate_weight_label" runat="server" Text="Food Weight"></asp:Label>

						<asp:TextBox TextMode="SingleLine" ID="donate_weight_text" runat="server" placeholder="Enter weight in kilograms(kgs)"></asp:TextBox>
                    ...
                    <div class="col-sm-5">
                        <asp:Label ID="no_of_persons" runat="server" Text="How many persons can eat?"></asp:Label>
                        
                        <asp:TextBox TextMode="SingleLine" ID="donate_persons_text" runat="server" placeholder="Example: 5"></asp:TextBox>
                        
                        <asp:RequiredFieldValidator CssClass="error" ID="persons_val" runat="server" ErrorMessage="Number of persons are required" SetFocusOnError="True" ControlToValidate="donate_persons_text"></asp:RequiredFieldValidator>
				...
				<div class="row">
					...
					<div class="col-sm-10">
						...
						<br />
						<asp:TextBox TextMode="MultiLine" ID="donate_desc_text" runat="server" placeholder="Add name of food and for how many persons you are donating"></asp:TextBox>
